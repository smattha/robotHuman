class CORSI_MSG:
    ...
    Στο τέλος θα πρέπει να πατήσεις τα τετραγωνάκια στα οποία εμφανίστηκε, με την ίδια σειρά .<br><br>\
    ...
    INSTRUNCTIONS_ROS="Θα εμφανιστούν στην οθόνη εννέα τετραγωνάκια.\
    Έπειτα ένα πιθηκάκι θα μετακινείται από τετραγώνακι σε τετραγωνάκι.\
    Στο τέλος θα πρέπει να πατήσεις τα τετραγωνάκια στα οποία εμφανίστηκε, με την ίδια σειρά \
    Πάτα το space  για να ξεκινήσουμε!\
    ...
    WRONG_ROS="Λάθος.Για να σε βοηθήσω,τo πιθηκάκι θα μένει περισσοτέρη ώρα σε κάθε πλακάκι."
    ...
    def countDown_ros(self,level,countdown):
       if (int(countdown)<1):
           return ''
    ...
    def finishedMsg(self,time,maxC):
        ...
        Μέσος χρόνος ανά αλυσίδας: '+ str(time)+ '.' + \
        ' Μήκος μέγιστης αλυσίδας: '+ str(maxC)+\
