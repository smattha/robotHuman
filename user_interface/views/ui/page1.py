...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_5.addWidget(self.answer4Img, 3, 3, 1, 1)
        self.answer3Img = QtWidgets.QLabel(self.widget)
        self.answer3Img.setObjectName("answer3Img")
        self.gridLayout_5.addWidget(self.answer3Img, 3, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.answer1Img, 3, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.mainImage, 2, 1, 1, 3, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_5.addWidget(self.answer2Img, 3, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.answer4Img.setText(_translate("Form", "TextLabel"))
        self.answer3Img.setText(_translate("Form", "TextLabel"))
        self.answer1.setText(_translate("Form", "A"))
        self.answer1Img.setText(_translate("Form", "TextLabel"))
        self.mainImage.setText(_translate("Form", "TextLabel"))
        self.name.setText(_translate("Form", "Δραστηριότητα"))
        self.answer2Img.setText(_translate("Form", "TextLabel"))
        self.answer3.setText(_translate("Form", "Γ"))
        self.answer5Img.setText(_translate("Form", "TextLabel"))
